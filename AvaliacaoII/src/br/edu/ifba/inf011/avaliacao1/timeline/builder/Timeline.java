...
public class Timeline implements Forkable, RenderableContent{
    ...
    public void render(Integer inicio, Integer duration) {
        ...
        System.out.println("[Timeline] Iniciando renderização do bloco: " + inicio + "s até " + fimDesejado + "s.");
        this.renderChannel(this.videoTracks, inicio, fimDesejado);
        this.renderChannel(this.audioTracks, inicio, fimDesejado);
        this.renderChannel(this.subtitleTracks, inicio, fimDesejado);
        System.out.println("[Timeline] Renderização do bloco concluída.");
    }

	private void renderChannel(List<? extends Track> tracks, Integer inicio, Integer fimDesejado) {
